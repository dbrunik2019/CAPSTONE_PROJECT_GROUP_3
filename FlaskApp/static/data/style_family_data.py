...
name = ['Pale Lager', 'Pale Ale', 'Wheat Beer', 'Amber Ale', 'Porter', 'IPA', 'Brown Ale', 'Stout', 'Strong Ale']

img = ['pale_lager', 'pale_ale', 'wheat_beer', 'amber_ale', 'porter', 'IPA', 'brown_ale', 'stout', 'strong_ale']
